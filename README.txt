...
Model Pipe Line:
The clustering model produces 'patient segment label' and Regression model produces length of stay' and Finally, The model uses the readmittance duration as a feature and performs the classification task to predict whether a hospitalised patient with diabetes will be readmitted within 30 days.
